                ...
                ->arrayNode('collectors')
                    ...
                    ->children()
                        ->arrayNode('doctrine')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('prefix')->cannotBeEmpty()->defaultValue('php.doctrine')->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
                ->arrayNode('reporters')
                    ...
                    ->children()
                        ...
                        ->arrayNode('newrelic')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('application_name')->cannotBeEmpty()->defaultValue('PHP Application')->end()
